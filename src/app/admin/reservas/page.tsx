...
export default async function ReservationsPage() {
  ...
  return <CentralShell title="Reservas" current="/admin/reservas" name={context.organization.name} email={context.email} role={context.role}>
    <section className="ui-panel"><p className="status-badge">Gestão ainda não disponível</p><h2>Como funcionam as solicitações</h2>
    ...
    <Link className="text-link" href="/admin/interessados" prefetch={false}>Consultar interessados recebidos</Link>
    </section>
  </CentralShell>;
}
