...
export default async function ReservationsPage() {
  ...
  return <CentralShell title="Reservas" current="/admin/reservas" name={context.organization.name}>
    ...
    <p>O fluxo público atual atende ao catálogo demonstrativo. Cadastrar sua frota não publica veículos nem habilita solicitações públicas para sua locadora.</p>
