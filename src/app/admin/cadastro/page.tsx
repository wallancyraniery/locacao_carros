...
export default async function SignupPage() {
  ...
  return <section className="admin-login"><div className="auth-brand"><ImproveBrand /><span>Central da locadora</span></div><h1>Crie sua conta</h1><p>O primeiro passo para organizar sua locadora.</p>
