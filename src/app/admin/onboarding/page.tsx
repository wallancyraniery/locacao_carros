...
export default async function OnboardingPage() {
  ...
  return <section className="admin-login"><div className="auth-brand"><ImproveBrand /><span>Central da locadora</span></div><header className="admin-heading"><h1>Crie sua locadora</h1><LogoutForm /></header>
