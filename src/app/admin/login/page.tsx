...
export default async function LoginPage({ searchParams }: { searchParams?: Promise<{ confirmation?: string }> }) {
  ...
  return <section className="admin-login"><div className="auth-brand"><ImproveBrand /><span>Central da locadora</span></div><h1>Entre na sua locadora</h1><p>Acesse sua área privada com e-mail e senha.</p>
