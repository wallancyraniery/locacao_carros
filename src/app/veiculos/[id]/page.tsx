  ...
  return <main className="vehicle-detail-page">
    ...
    <article className="vehicle-detail">
      ...
      <div className="vehicle-detail-content">
        ...
        <div className="detail-heading"><h1>{vehicle.model}</h1><span className={`status ${vehicle.acceptsInterest ? "status-available" : "status-unavailable"}`}>{vehicle.availabilityLabel}</span></div>
