...
export function PrivacyNotice({ configuration }: { configuration: PrivacyNoticeConfiguration }) {
  return <aside className="privacy-notice" aria-labelledby="privacy-notice-title">
    ...
    <p>A locadora responsável pelo veículo usará os dados somente para analisar esta manifestação de interesse e realizar contato.</p>
