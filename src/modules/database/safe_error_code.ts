...
const safeErrorCodes = new Set([
  ...
  "INVALID_RUNTIME_DATABASE_ENVIRONMENT", "INVALID_PRODUCTION_ENVIRONMENT",
  "CONNECT_TIMEOUT", "CONNECTION_CLOSED",
  "INVALID_PRIVACY_NOTICE_ENVIRONMENT", "INVALID_TURNSTILE_ENVIRONMENT", "TURNSTILE_UNAVAILABLE",
